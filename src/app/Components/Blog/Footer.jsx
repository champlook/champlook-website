...
export const Footer = () => {
    return (
      ...
      <div className="bg-gray-200 w-screen h-[30rem] ml-[0rem] foot-mh">

        <div className="flex flex-row w-full h-[24rem] foot-res">
          <div className="w-3/6 h-full mt-[3rem] foot-left pl-[12rem]">
          <h1 className="font-avnextb font-extralight text-22xl">Fueled by ❤️ for <br /><mark className="text-sky-400 bg-gray-200">software </mark>and the <br />brilliant minds <mark className="text-green-400 bg-gray-200">behind <br />it</mark>.</h1>
          </div>

          <div className="w-1/2 h-full flex flex-row  mr-[8rem] mt-[3rem] foot-right">
       ...
       <div className=" h-[6rem] w-full pl-[12rem] cpdiv">
