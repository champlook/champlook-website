...
export const Navbar = () => {
  return (
    <div className="absolute top-[0rem] left-[0rem] bg-white w-[90rem] h-[5.38rem] text-center text-[1.13rem] text-dimgray-200 font-avnextr">
      <Link href="#" >
        <Image
      ...
      <button className="cursor-pointer p-0 bg-white absolute top-[1.19rem] left-[78.69rem] rounded-lg shadow-[0px_4px_4px_rgba(0,_0,_0,_0.1)] box-border w-[9.86rem] h-[3rem] overflow-hidden [transform:_rotate(-0.36deg)] [transform-origin:0_0] border-[1px] border-solid border-black">
        <div className="absolute top-[0.61rem] left-[3.12rem] text-[1.38rem] leading-[125%] font-avenir-next text-black text-center">
          Login
        </div>
      </button>
      <button className="cursor-pointer p-0 bg-crimson-100 absolute top-[1.19rem] left-[68.19rem] rounded-lg shadow-[0px_4px_4px_rgba(0,_0,_0,_0.1)] box-border w-[9.86rem] h-[3rem] overflow-hidden [transform:_rotate(-0.36deg)] [transform-origin:0_0] border-[1px] border-solid border-black hover:animate-[2s_ease-in_0s_1_normal_none_shadow-drop-bottom] hover:opacity-[1]">
