...
const Applicability = () => {
  return (
    ...
    <div className=" mt-[2rem]">This policy applies to all areas associated with Champlook, including the following and their online   equivalents (if applicable):</div>
