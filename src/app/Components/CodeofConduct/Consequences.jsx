  ...
  return (
    <>
      ...
      <div className="leading-8 mt-[2rem]">
        If a participant breaches this Code of Conduct, the organiser reserves
        the right to take the following actions at their discretion
      </div>
      <ul className="list-disc">
        ...
        <li>
          Restrict the participant's access to Champlook resources, including
          the website
        </li>
