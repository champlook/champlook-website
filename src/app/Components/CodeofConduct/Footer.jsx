...
const Footer = (props) => {
  return (
    <>
      <div className=" font-avnext text-[#00005C] font-bold text-3xl mt-[2rem]">
        Contact Us
      </div>
      ...
      <div className="flex  justify-evenly  pb-[4rem] flex-col  sm:flex-row">
        ...
        <div className="w-[100%]  sm:w-[50%]  bg-white   sm:ml-8 h-auto shadow-lg rounded">
          <div className="ml-6 font-avnext text-[#00005C] font-bold text-3xl mt-[1rem]">
            Champlook
          </div>
          ...
          <div className="flex justify-start">
            ...
            ></Image>
            <div className="ml-2 mt-2 text-black pb-[2rem]">
