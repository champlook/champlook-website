...
//       <div className="absolute  w-full top-[0rem] right-[20rem] bottom-[191rem] left-[20rem] text-[1.88rem] font-avnextb">
...
//         </Image>
//       </div>
//       <div className="absolute  w-full top-[14.53rem] right-[20rem] bottom-[167.53rem] left-[20rem] text-[1.06rem] text-gray">
//         <div className="absolute  w-full top-[1.44rem] right-[0rem] bottom-[19.34rem] left-[0rem] box-border text-[1.56rem] text-crimson font-avnextb border-b-[1px] border-solid border-lightgray-100">
//           <b className="absolute top-[0rem] left-[0rem] leading-[2.31rem] text-[#D81F1F]">
//             Applicability
//           </b>
//         </div>
//         <div className="absolute  w-[calc(100%_+_10px)] top-[5.63rem] right-[-0.31rem] bottom-[14.72rem] left-[-0.31rem] ">
...
//           </div>
//         </div>
//         <div className="absolute  w-full top-[9.81rem] bottom-[5.66rem]  flex flex-col py-[0rem] pr-[33.25rem] pl-[2.5rem] box-border items-start justify-start text-[inherit] font-inherit">
...
//         </div>
//       </div>
//       <div className="absolute  w-full top-[38rem] right-[20rem] bottom-[147.88rem] left-[20rem] text-[1.06rem] text-gray">
//         <div className="absolute  w-full top-[1.44rem] right-[0rem] bottom-[15.53rem] left-[0rem] box-border flex font-avnextb flex-row pt-[0rem] pb-[0.38rem] pr-[21.88rem] pl-[0rem] items-start justify-start text-[1.56rem] text-crimson border-b-[1px] border-solid border-lightgray-100">
//           <b className="relative leading-[2.31rem] text-[#D81F1F]">
//             No plagiarism or re-using of past work
//           </b>
//         </div>
//         <div className="absolute  w-full top-[4.84rem] right-[0.03rem] bottom-[7rem] left-[0.03rem] flex flex-row py-[0rem] pr-[0.06rem] pl-[0rem] box-border items-start justify-start">
...
//           </div>
//         </div>
//         <div className="absolute  w-full top-[13.44rem] right-[1.5rem] bottom-[1.53rem] left-[0rem] flex flex-row py-[0rem] pr-[1.56rem] pl-[0rem] box-border items-start justify-start">
...
//         </div>
//       </div>
//       <div className="absolute w-full top-[57.66rem] right-[20rem] bottom-[110.03rem] left-[20rem] text-gray">
//         <div className="absolute  w-full top-[1.44rem] right-[0rem] bottom-[33.72rem] left-[0rem] box-border flex flex-row pt-[0rem] pb-[0.38rem] pr-[37.31rem] pl-[0rem] items-start justify-start text-crimson border-b-[1px] border-solid border-lightgray-100">
//           <b className="relative leading-[2.31rem] text-[#D81F1F] font-avnextb ">No discrimination</b>
//         </div>
//         <div className="absolute  w-full top-[6.41rem] right-[0.47rem] bottom-[28.31rem] left-[0.47rem] flex flex-row py-[0rem] pr-[2.94rem] pl-[0rem] box-border items-start justify-start text-[1.06rem]">
...
//           </div>
//         </div>
//         <div className="absolute w-full top-[calc(50%_-_120.75px)] right-[-1.22rem] left-[-1.22rem] flex flex-col py-[0rem] pr-[26.38rem] pl-[2.5rem] box-border items-start justify-start text-[inherit] font-nunito-sans font-normal">
//           <div className="relative leading-[1.59rem]">
//             <ul className="m-0 pl-[1.35rem]">
...
//         </div>
//       </div>
//       <div className="absolute w-full top-[95.5rem] right-[20rem] bottom-[96.66rem] left-[20rem] flex flex-col pt-[1.44rem] px-[0rem] pb-[1.5rem] box-border items-start justify-start gap-[1.5rem]">
...
//         </div>
//       </div>
//       <div className="absolute  w-full top-[108.88rem] right-[20rem] bottom-[74.47rem] left-[20rem] text-[1.06rem] text-gray">
//         <div className="absolute  w-full top-[1.13rem] right-[0rem] bottom-[18.38rem] left-[0rem] box-border flex flex-row pt-[0rem] pb-[0.38rem] pr-[28.44rem] pl-[0rem] items-start justify-start text-[1.56rem] text-crimson border-b-[1px] border-solid border-lightgray-100">
//           <b className="relative leading-[2.31rem] text-[#D81F1F] font-avnextb">
//             No recording without consent
//           </b>
//         </div>
//         <div className="absolute  w-full top-[4.53rem] right-[-0.28rem] bottom-[11.41rem] left-[-0.28rem] flex flex-row py-[0rem] pr-[0.56rem] pl-[0rem] box-border items-start justify-start">
...
//           </div>
//         </div>
//         <div className="absolute  w-full top-[13.13rem] right-[0.13rem] bottom-[5.94rem] left-[0.13rem] flex flex-row py-[0rem] pr-[1.63rem] pl-[0rem] box-border items-start justify-start">
...
//         </div>
//       </div>
//       <div className="absolute  w-full top-[131.06rem] right-[18rem] bottom-[62.66rem] left-[20rem] flex flex-col pt-[1.44rem] px-[0rem] pb-[1.5rem] box-border items-start justify-start gap-[1.5rem]">
...
//         </div>
//       </div>
//       <div className="absolute  w-full top-[142.88rem] right-[17.38rem] bottom-[49.28rem] left-[20rem] flex flex-col pt-[1.44rem] px-[0rem] pb-[1.5rem] box-border items-start justify-start gap-[1.5rem]">
...
//         </div>
//       </div>
//       <div className="absolute w-full top-[156.25rem] right-[20rem] bottom-[34.31rem] left-[20rem]">
//         <div className="absolute  w-full top-[1.44rem] right-[0rem] bottom-[10.84rem] left-[0rem] box-border flex flex-row pt-[0rem] pb-[0.38rem] pr-[39.63rem] pl-[0rem] items-start justify-start border-b-[1px] border-solid border-lightgray-100">
//           <b className="relative leading-[2.31rem] text-[#D81F1F] font-avnextb">Always report</b>
//         </div>
//         <div className="absolute w-full top-[calc(50%_+_33.25px)] right-[0.38rem] left-[0.38rem] flex flex-row py-[0rem] pr-[2.81rem] pl-[0rem] box-border items-start justify-start text-[1.06rem] text-gray">
...
//           </div>
//         </div>
//         <div className="absolute  w-full top-[10.34rem] right-[0rem] bottom-[1.5rem] left-[0rem]" />
//       </div>
//       <div className="absolute  w-full top-[171.22rem] right-[20rem] bottom-[18.72rem] left-[20rem]">
//         <div className="absolute  w-full top-[1.44rem] right-[0rem] bottom-[11.47rem] left-[0rem] box-border flex flex-row pt-[0rem] pb-[0.38rem] pr-[30.25rem] pl-[0rem] items-start justify-start border-b-[1px] border-solid border-lightgray-100">
//           <b className="relative leading-[2.31rem] text-[#D81F1F] font-avnextb">
...
//       <div className="absolute   top-[192.44rem] right-[17.19rem] bottom-[1.5rem] left-[20rem]" />
//       <div className="absolute  top-[calc(50%_+_1434.75px)] right-[46rem] left-[19.75rem] h-[11.59rem] text-[1.06rem] text-white ">
...
//         </div>
//       </div>
//       <div className="absolute w-full top-[192.44rem] right-[17.19rem] bottom-[1.5rem] left-[46.25rem]">
...
//       </div>
//       <div className="absolute w-full top-[196.75rem] right-[18.69rem] bottom-[7.16rem] left-[47.75rem] flex flex-row py-[0rem] pr-[9.13rem] pl-[0rem] box-border items-center justify-start gap-[1rem] text-[1.06rem] text-royalblue">
...
const CodeOfConduct = () => {
  return (
    <div className="bg-[#F5F7F7] pl-[5rem] pr-[17rem]">
      ...
      <div className=" color text-[#D81F1F] font-bold text-3xl absolute top-[10rem]" >Terms of Use</div>

      <div className=" color text-[#D81F1F] font-bold text-3xl absolute top-[14rem]" >Applicability Rahul Vijay Singh  Rahul Vijay Singh Rahul Vijay Singh Rahul Vijay Singh Rahul Vijay Singh Rahul Vijay Singh Rahul Vijay Singh Rahul Vijay Singh</div>
